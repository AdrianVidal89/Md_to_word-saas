...
const I18N = {
  en: {
    ...
    pricing: {
      ...
      pro: { name: "Pro", price: "€3.99", period: "/ month", desc: "For a couple of coffees a month ☕ — for your own corporate template.",
  ...
  es: {
    ...
    pricing: {
      ...
      pro: { name: "Pro", price: "3,99€", period: "/ mes", desc: "Por unos cafés al mes ☕ — para tu propia plantilla corporativa.",
  ...
  fr: {
    ...
    pricing: {
      ...
      pro: { name: "Pro", price: "3,99 €", period: "/ mois", desc: "Pour quelques cafés par mois ☕ — pour votre propre modèle d'entreprise.",
  ...
  pt: {
    ...
    pricing: {
      ...
      pro: { name: "Pro", price: "3,99 €", period: "/ mês", desc: "Por uns cafés por mês ☕ — para o seu próprio modelo corporativo.",
  ...
  de: {
    ...
    pricing: {
      ...
      pro: { name: "Pro", price: "3,99 €", period: "/ Monat", desc: "Für ein paar Kaffees im Monat ☕ — für Ihre eigene Unternehmensvorlage.",
  ...
  zh: {
    ...
    pricing: {
      ...
      free: { name: "免费版", price: "€0", period: "永久", desc: "引流利器——比市面上其他免费转换工具更好用。",
        ...
        cta: "开始转换" },
      pro: { name: "专业版", price: "€3.99", period: "/ 月", desc: "每月几杯咖啡的价格 ☕——用来使用你自己的企业模板。",
