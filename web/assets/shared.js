...
const I18N = {
  en: {
    ...
    homeFaq: {
      ...
      q1: "How do I convert a ChatGPT or Claude answer into a Word document?",
      a1: "Paste the answer into the box above and click convert. AI to Doc turns the Markdown your AI produced into a clean, formatted .docx you can download instantly — no copy-paste cleanup, no tags, no code.",
      q2: "Is this Markdown to Word converter free?",
      a2: "Yes. Converting with the clean default template is free and unlimited, with no signup required. You only need an account if you want to bring your own corporate Word template.",
      q3: "Can I use my own corporate Word template?",
      a3: "Yes. With a free account you can upload your own .docx/.dotx template once and reuse it on every conversion, so every document matches your brand's styles, headings and fonts.",
      q4: "Do I need to install anything or create an account?",
      a4: "No. AI to Doc runs entirely in your browser — no install, no plugin, and no account needed for the free converter. Just paste, convert and download.",
    },
    auth: {
  ...
  es: {
    ...
    homeFaq: {
      ...
      q1: "¿Cómo convierto una respuesta de ChatGPT o Claude en un documento Word?",
      a1: "Pega la respuesta en el recuadro de arriba y pulsa convertir. AI to Doc transforma el Markdown que genera tu IA en un .docx limpio y con formato que descargas al instante — sin limpiar copiando y pegando, sin tags, sin código.",
      q2: "¿Este conversor de Markdown a Word es gratis?",
      a2: "Sí. Convertir con la plantilla limpia por defecto es gratis e ilimitado, sin registro. Solo necesitas cuenta si quieres usar tu propia plantilla corporativa de Word.",
      q3: "¿Puedo usar mi propia plantilla corporativa de Word?",
      a3: "Sí. Con una cuenta gratuita subes tu plantilla .docx/.dotx una vez y la reutilizas en cada conversión, para que cada documento respete los estilos, encabezados y fuentes de tu marca.",
      q4: "¿Necesito instalar algo o crear una cuenta?",
      a4: "No. AI to Doc funciona entero en tu navegador — sin instalar nada, sin plugin y sin cuenta para el conversor gratuito. Solo pega, convierte y descarga.",
    },
    auth: {
  ...
  fr: {
    ...
    homeFaq: {
      ...
      q1: "Comment convertir une réponse de ChatGPT ou Claude en document Word ?",
      a1: "Collez la réponse dans le champ ci-dessus et cliquez sur convertir. AI to Doc transforme le Markdown produit par votre IA en un .docx propre et mis en forme, téléchargeable instantanément — sans nettoyage, sans balises, sans code.",
      q2: "Ce convertisseur Markdown vers Word est-il gratuit ?",
      a2: "Oui. La conversion avec le modèle propre par défaut est gratuite et illimitée, sans inscription. Un compte n'est nécessaire que pour utiliser votre propre modèle Word d'entreprise.",
      q3: "Puis-je utiliser mon propre modèle Word d'entreprise ?",
      a3: "Oui. Avec un compte gratuit, importez votre modèle .docx/.dotx une seule fois et réutilisez-le à chaque conversion, pour que chaque document respecte les styles, titres et polices de votre marque.",
      q4: "Dois-je installer quelque chose ou créer un compte ?",
      a4: "Non. AI to Doc fonctionne entièrement dans votre navigateur — sans installation, sans extension et sans compte pour le convertisseur gratuit. Collez, convertissez, téléchargez.",
    },
    auth: {
  ...
  pt: {
    ...
    homeFaq: {
      ...
      q1: "Como converto uma resposta do ChatGPT ou Claude num documento Word?",
      a1: "Cole a resposta na caixa acima e clique em converter. O AI to Doc transforma o Markdown que a sua IA produz num .docx limpo e formatado que descarrega ao instante — sem limpezas, sem tags, sem código.",
      q2: "Este conversor de Markdown para Word é grátis?",
      a2: "Sim. Converter com o modelo limpo predefinido é grátis e ilimitado, sem registo. Só precisa de conta se quiser usar o seu próprio modelo Word da empresa.",
      q3: "Posso usar o meu próprio modelo Word da empresa?",
      a3: "Sim. Com uma conta gratuita carrega o seu modelo .docx/.dotx uma vez e reutiliza-o em cada conversão, para que cada documento respeite os estilos, títulos e tipos de letra da sua marca.",
      q4: "Preciso de instalar algo ou criar uma conta?",
      a4: "Não. O AI to Doc funciona inteiramente no seu navegador — sem instalação, sem plugin e sem conta para o conversor gratuito. Basta colar, converter e descarregar.",
    },
    auth: {
  ...
  de: {
    ...
    homeFaq: {
      ...
      q1: "Wie wandle ich eine Antwort von ChatGPT oder Claude in ein Word-Dokument um?",
      a1: "Fügen Sie die Antwort oben ein und klicken Sie auf Konvertieren. AI to Doc verwandelt das von Ihrer KI erzeugte Markdown in ein sauberes, formatiertes .docx, das Sie sofort herunterladen können — ohne Nachbearbeiten, ohne Tags, ohne Code.",
      q2: "Ist dieser Markdown-zu-Word-Konverter kostenlos?",
      a2: "Ja. Das Konvertieren mit der sauberen Standardvorlage ist kostenlos und unbegrenzt, ohne Anmeldung. Ein Konto brauchen Sie nur, wenn Sie Ihre eigene Word-Firmenvorlage verwenden möchten.",
      q3: "Kann ich meine eigene Word-Firmenvorlage verwenden?",
      a3: "Ja. Mit einem kostenlosen Konto laden Sie Ihre .docx/.dotx-Vorlage einmal hoch und verwenden sie bei jeder Konvertierung wieder, damit jedes Dokument den Stilen, Überschriften und Schriften Ihrer Marke entspricht.",
      q4: "Muss ich etwas installieren oder ein Konto erstellen?",
      a4: "Nein. AI to Doc läuft vollständig in Ihrem Browser — ohne Installation, ohne Plug-in und ohne Konto für den kostenlosen Konverter. Einfach einfügen, konvertieren, herunterladen.",
    },
    auth: {
  ...
  zh: {
    ...
    homeFaq: {
      title: "常见问题",
      q1: "如何把 ChatGPT 或 Claude 的回答转换成 Word 文档？",
      a1: "把回答粘贴到上面的框中并点击转换。AI to Doc 会把你的 AI 生成的 Markdown 转成干净、带格式的 .docx，可立即下载——无需手动整理，无标签，无代码。",
      q2: "这个 Markdown 转 Word 的工具免费吗？",
      a2: "免费。使用默认的干净模板转换是免费且无限制的，无需注册。只有当你想使用自己的企业 Word 模板时才需要账户。",
      q3: "我可以使用自己的企业 Word 模板吗？",
      a3: "可以。用免费账户上传一次你的 .docx/.dotx 模板，即可在每次转换中重复使用，让每份文档都符合你品牌的样式、标题和字体。",
      q4: "我需要安装任何东西或创建账户吗？",
      a4: "不需要。AI to Doc 完全在你的浏览器中运行——免费转换器无需安装、无需插件、无需账户。只需粘贴、转换、下载。",
    },
    auth: {
