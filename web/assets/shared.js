...
const I18N = {
  ...
  pt: {
    ...
    wizard: {
      ...
      convertBtn: "Converter com o meu modelo",
      trialNote: "Plano gratuito: a sua primeira descarga com um modelo personalizado é grátis. Depois disso, é necessário o Pro.",
    ...
    pricing: {
      ...
      free: { name: "Grátis", price: "0 €", period: "para sempre", desc: "O isco — melhor do que os outros conversores gratuitos por aí.",
        f1: "Conversões ilimitadas", f2: "Sem registo necessário", f3: "Modelo genérico limpo", f4: "Coloração Pass/Fail em tabelas",
        cta: "Começar a converter" },
      pro: { name: "Pro", price: "3,99 €", period: "/ mês", desc: "Menos do que um café por mês — para o seu próprio modelo corporativo.",
        f1: "Modelo .dotx/.docx próprio e persistente", f2: "Associação automática de estilos (com opção manual)", f3: "Regras condicionais (Pass/Fail)", f4: "1 descarga de avaliação grátis antes de pagar",
  ...
  de: {
    ...
    wizard: {
      ...
      convertBtn: "Mit meiner Vorlage konvertieren",
      trialNote: "Kostenloser Plan: Ihr erster Download mit einer eigenen Vorlage ist kostenlos. Danach ist ein Upgrade auf Pro erforderlich.",
    ...
    pricing: {
      ...
      free: { name: "Kostenlos", price: "0 €", period: "für immer", desc: "Der Türöffner — besser als die anderen kostenlosen Konverter da draußen.",
        f1: "Unbegrenzte Konvertierungen", f2: "Keine Registrierung nötig", f3: "Saubere generische Vorlage", f4: "Pass/Fail-Einfärbung in Tabellen",
        cta: "Jetzt konvertieren" },
      pro: { name: "Pro", price: "3,99 €", period: "/ Monat", desc: "Weniger als ein Kaffee im Monat — für Ihre eigene Unternehmensvorlage.",
        f1: "Persistente eigene .dotx/.docx-Vorlage", f2: "Automatische Stilzuordnung (mit manueller Option)", f3: "Bedingte Regeln (Pass/Fail)", f4: "1 kostenloser Testdownload vor der Zahlung",
  ...
  zh: {
    ...
    wizard: {
      ...
      convertBtn: "使用我的模板转换",
      trialNote: "免费版：使用自定义模板的第一次下载是免费的。之后需要升级到专业版。",
    ...
    pricing: {
      ...
      free: { name: "免费版", price: "€0", period: "永久", desc: "引流利器——比市面上其他免费转换工具更好用。",
        f1: "无限次转换", f2: "无需注册", f3: "简洁的通用模板", f4: "表格中的 Pass/Fail 自动上色",
        cta: "开始转换" },
      pro: { name: "专业版", price: "€3.99", period: "/ 月", desc: "每月不到一杯咖啡的价格——用来使用你自己的企业模板。",
        f1: "持久保存的自定义 .dotx/.docx 模板", f2: "自动样式映射（带手动备选方案）", f3: "条件规则（Pass/Fail）", f4: "付费前 1 次免费试用下载",
